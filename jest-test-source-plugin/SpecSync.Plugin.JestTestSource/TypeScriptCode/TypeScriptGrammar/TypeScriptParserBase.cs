...
namespace SpecSync.PluginDependency.TypeScriptSource.TypeScriptCode.TypeScriptGrammar;
...
public abstract class TypeScriptParserBase : Parser
{
    ...
    public TypeScriptParserBase(ITokenStream input, TextWriter output, TextWriter errorOutput)
