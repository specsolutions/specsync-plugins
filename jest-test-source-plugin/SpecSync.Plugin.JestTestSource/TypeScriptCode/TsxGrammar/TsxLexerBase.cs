...
namespace SpecSync.PluginDependency.TypeScriptSource.TypeScriptCode.TsxGrammar;

/// <summary>
/// All lexer methods that used in grammar (IsStrictMode)
/// should start with Upper Case Char similar to Lexer rules.
/// </summary>
public abstract class TsxLexerBase : Lexer
{
    /// <summary>
    ...
    public TsxLexerBase(ICharStream input, TextWriter output, TextWriter errorOutput)
    ...
    public override int PopMode()
    {
        ...
        {
            throw new SpecSyncException("Invalid token nesting");
        }
    }
}
